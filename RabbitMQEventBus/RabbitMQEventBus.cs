...
namespace VoteDemo.BuildingBlocks.RabbitMQEventBus
{
    ...
    {
        const string BROKER_NAME = "votedemo_event_bus";
        ...
        public RabbitMQEventBus(IRabbitMQPersistentConnection persistentConnection, ILogger<RabbitMQEventBus> logger, IEventBusSubscriptionsManager subsManager)
        {
